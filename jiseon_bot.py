...
questions = [
    ...
    "5. 돌파 시작 3분 이내 10% 이상 급등한 종목은 아닌가요? (Y/N)", 
    "6. 1분봉 상 25억 이상의 거래대금이 2번 이상 발생했나요? (Y/N)",
    "7. 1분봉 상 박스권을 만들었나요? (Y/N)",
    "8. 1분봉 상 4개의 봉이 만들어졌나요? (Y/N)", 
    "9. 1분봉 상 급등/급락을 반복하지 않나요? (Y/N)", 
    "10. 단기 전고점 대비 -4.5% 이상 하락하지 않았나요? (Y/N)", 
    "11. 좋은 뉴스가 발생했나요? (Y/N)"
]
user_states = {}
